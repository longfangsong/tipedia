import * as wasm from './tidb_key_tools_bg.wasm';
...
* @returns {Record}
*/
export function parse_record(code) {
    var ptr0 = passArray8ToWasm0(code, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    var ret = wasm.parse_record(ptr0, len0);
...
* @returns {Uint8Array}
*/
export function parse_golang_fmt_print(code) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.parse_golang_fmt_print(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v1 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
...
* @returns {Uint8Array}
*/
export function parse_hex_encoded(code) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.parse_hex_encoded(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v1 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
...
* @returns {BigInt}
*/
export function big_endian_decode_u64(code) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passArray8ToWasm0(code, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.big_endian_decode_u64(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        u32CvtShim[0] = r0;
        u32CvtShim[1] = r1;
...
* @param {BigInt} n
*/
export function big_endian_encode_u64(buf, n) {
    try {
        ...
        wasm.big_endian_encode_u64(ptr0, len0, low1, high1);
    } finally {
...
* @returns {BigInt}
*/
export function little_endian_decode_u64(code) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passArray8ToWasm0(code, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.little_endian_decode_u64(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        u32CvtShim[0] = r0;
        u32CvtShim[1] = r1;
...
* @param {BigInt} n
*/
export function little_endian_encode_u64(buf, n) {
    try {
        var ptr0 = passArray8ToWasm0(buf, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        uint64CvtShim[0] = n;
        const low1 = u32CvtShim[0];
        const high1 = u32CvtShim[1];
        wasm.little_endian_encode_u64(ptr0, len0, low1, high1);
    } finally {
        buf.set(getUint8Memory0().subarray(ptr0 / 1, ptr0 / 1 + len0));
        wasm.__wbindgen_free(ptr0, len0 * 1);
    }
...
export class Record {
    ...
    */
    get table_id() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_record_table_id(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            u32CvtShim[0] = r0;
            u32CvtShim[1] = r1;
    ...
    */
    set table_id(arg0) {
        ...
        wasm.__wbg_set_record_table_id(this.ptr, low0, high0);
    }
    /**
    * @returns {BigInt}
    */
    get row_id() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_record_row_id(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            u32CvtShim[0] = r0;
            u32CvtShim[1] = r1;
    ...
    */
    set row_id(arg0) {
        ...
        const low0 = u32CvtShim[0];
        const high0 = u32CvtShim[1];
        wasm.__wbg_set_record_row_id(this.ptr, low0, high0);
    }
}
/**
*/
